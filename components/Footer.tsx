    ...
    >
      ...
      <div
        style={{
          ...
          maskImage:
            "linear-gradient(to bottom, transparent 0%, rgba(0,0,0,0.25) 30%, rgba(0,0,0,0.25) 70%, transparent 100%)",
        }}
      />
      ...
      <motion.div
        ...
        style={{
          height: 1,
          background:
            "linear-gradient(90deg, transparent 0%, rgba(74,222,128,0.18) 20%, rgba(74,222,128,0.55) 50%, rgba(74,222,128,0.18) 80%, transparent 100%)",
      ...
      <div
        style={{
          ...
          zIndex: 1,
          padding:
            "clamp(48px, 5.5vw, 80px) clamp(24px, 5vw, 80px) clamp(32px, 4vw, 52px)",
        }}
      >
        {/* Top: 6-column grid */}
        <div
              ...
              {SOCIALS.map((s) => (
                <motion.a
                  ...
                  style={{
                    ...
                    textDecoration: "none",
                    transition:
                      "color 0.22s, border-color 0.22s, background 0.22s, box-shadow 0.22s",
                  }}
                  onMouseEnter={(e) => {
