...
const TEAM = [
  ...
  { name: 'Gaurav Jain',           role: 'Co-founder / CEO & Head of Operations',          img: '/team/Gaurav_Jain.webp',          accent: '#4ADE80' },
  ...
  { name: 'Saral Shrivastava',     role: 'MERN Stack Developer',                           img: '/team/Saral_shrivastava.webp',    accent: '#4ADE80' },
  ...
  { name: 'Sandeep Sahu',          role: 'MERN Stack Developer',                           img: '/team/Sandeep_sahu.webp',         accent: '#4ADE80' },
  ...
  { name: 'Nitesh Biswas',         role: 'Sr. UI/UX Designer',                             img: '/team/Nitesh_Biswas.webp',        accent: '#4ADE80' },
  ...
  // ── Laravel Developers ────────────────────────────────────────────────────
  { name: 'Praveen Kushwah',       role: 'Laravel Developer',                              img: '/team/Praveen_kushwah.webp',      accent: '#4ADE80' },
  ...
  { name: 'Pankaj Singh',          role: 'Software Quality Analyst',                       img: '/team/Pankaj.webp',               accent: '#4ADE80' },
...
const HERO_AVATARS = [
  { name: 'Gaurav Jain',         img: '/team/Gaurav_Jain.webp',          accent: '#4ADE80', x: 10, y: 10, size: 82, d: 0 },
  ...
  { name: 'Nitesh Biswas',       img: '/team/Nitesh_Biswas.webp',        accent: '#4ADE80', x: 16, y: 74, size: 58, d: 0.12 },
    ...
    <section style={{
      ...
      <motion.div
        ...
        style={{
          ...
          background: 'radial-gradient(ellipse, rgba(74,222,128,0.07) 0%, transparent 68%)',
          pointerEvents: 'none',
        }}
      />
      ...
      <div style={{
        ...
        >
          ...
          <div style={{
            ...
            <div style={{
              position: 'absolute', inset: 0,
              background: 'linear-gradient(135deg, rgba(74,222,128,0.04) 0%, rgba(167,139,250,0.03) 100%)',
            }} />
            ...
            <div style={{
              ...
              background: 'linear-gradient(to top, rgba(74,222,128,0.07), transparent)',
              pointerEvents: 'none',
            }} />
          </div>
          ...
          <div style={{
            ...
            background: 'linear-gradient(135deg, rgba(74,222,128,0.18), transparent 55%, rgba(167,139,250,0.12))',
            filter: 'blur(12px)',
          }} />
...
// ─── Life @ UpCodo Section ────────────────────────────────────────────────────
const LIFE_TILES = [
  { label: 'Team Syncs',       caption: 'Daily standups, weekly strategy',   accent: '#4ADE80', cols: 2, rows: 1, grad: 'linear-gradient(145deg, #1a1200 0%, #2d1f00 100%)' },
          ...
          >
            ...
            <motion.div
              ...
              style={{
                ...
                background: 'radial-gradient(circle at bottom right, rgba(74,222,128,0.08), transparent 70%)',
                pointerEvents: 'none',
              }}
            />
          </motion.div>
    ...
    <div ref={ref} style={{
      ...
      >
        <div style={{
          ...
          position: 'relative', overflow: 'hidden',
          boxShadow: inView ? '0 0 40px rgba(74,222,128,0.06)' : 'none',
          textAlign: 'left',
        }}>
          <div style={{
            position: 'absolute', top: 0, left: 0, right: 0, height: 1,
